...
<a href="https://github.com/0xFar3000">
  <img src="https://i.ibb.co/Y7NwBFNJ/image-2025-02-12-120416891.png" alt="Farès' GitHub Profile Banner" width="100%">
</a>
<br><br>
...
<div style="text-align: left; display: inline-block; max-width: 700px;">
  ...
  <p style="font-size:1em; margin-bottom: 0.3em;">
   💼 I'm currently working on: <strong>Data Analysis on BTC, PTAP (Project to AI Prompt)</strong>
   </p>
   <p style="font-size:1em; margin-bottom: 0.3em;">
   🔍 I'm currently learning: <strong>Pandas, Golang, Flask</strong>
   </p>
   <p style="font-size:1em; margin-bottom: 0.3em;">
   🗣️ You can ask me about: <strong>Python, API's (Usage / Scraping)</strong>
  </p>
</div>
...
<a href="https://www.instagram.com/fares_btl" target="_blank">
...
<!-- Order based on proficiency, most to least. Grouped logically. -->
...
<img src="https://img.shields.io/badge/OVH-123F6D?style=for-the-badge&logo=ovh&logoColor=#123F6D" alt="OVH">
